export default function WhatsAppFAB() {
  return (
    <a
      ...
      className="fixed bottom-8 right-8 bg-secondary text-on-secondary w-16 h-16 rounded-full shadow-2xl flex items-center justify-center hover:scale-110 active:scale-95 transition-transform z-50 pulse-whatsapp"
